...
@section('title','Editar tipo de Foto')
@section('breadcrumb')
<li class="breadcrumb-item active">
    <a href="{{route('provinces.index')}}">Tipo de Foto</a>
</li>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Editar de Tipo de Foto</h3>
	...
	<form id="form" method="POST">
        <div class="card-body ">
            ...
            <div class="form-group">
                <label for="">ID</label>
                <input type="text" name="ID_Tipo_Fotografia" id="ID_Tipo_Fotografia" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
...
<script>
	$(document).ready(function(){
		$("#submit").on('click', function(){
			...
			$.ajax({
				url: 'http://smartcityhyo.tk/api/Tipo_de_foto/Update_Tipo_de_fotografia.php',
				type: 'POST',
