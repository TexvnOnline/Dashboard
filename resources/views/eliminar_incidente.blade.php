...
@section('title','Eliminar Incidente')
@section('breadcrumb')
<li class="breadcrumb-item active">
    <a href="{{route('contacts.index')}}">Eliminar Lugar Incidente</a>
</li>
	...
	<form id="form" method="POST">
        <div class="card-body ">
            ...
            <div class="form-group">
              <label for="">Id incidente</label>
              <input type="text" name="ID_Incidente" id="ID_Incidente" class="form-control"  aria-describedby="helpId">
